                                            ...
                                            (() => {
                                                ...
                                                return filtered && filtered.length > 0 ? (
                                                    <MDBox display="flex" flexDirection="column" gap={1.5}>
                                                        {filtered.map((doc) => {
                                                            const url = doc.signed_url || doc.asset_url;
                                                            const name = safeDownloadName(doc);

                                                            return (
                                                                <Card key={doc.id} sx={{ overflow: "hidden" }}>
                                                                    <MDBox p={2} display="flex" alignItems="center" justifyContent="space-between" gap={2} flexWrap="wrap">
                                                                        <MDBox>
                                                                            ...
                                                                            <MDTypography variant="button" color="text">
                                                                                {doc.content_type ? doc.content_type : "unknown type"}{" "}
