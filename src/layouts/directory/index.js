...
const TYPE_CONFIG = {
    ...
    companies: {
        ...
        // backend supports q (and commonly sector in your directory patterns)
        fetcher: (params) => fetchPaged("/companies", params),
        renderCard: (item) => <DirectoryCompanyCard company={item} />,
        // for building dropdown options from current page
    ...
    users: {
        label: "Users",
        categoryLabel: "Role",
        // your /users directory endpoint already uses roleType in query in your other code
...
function Directory() {
    ...
    // server-side fetch for ALL tabs
    useEffect(() => {
        let active = true;
    ...
    // Build dropdown options from current page (safe + no extra API)
                    ...
                    <MDBox px={3} pb={2}>
                        ...
                        >
                            ...
                            <MDBox display="flex" gap={1} flex={1} justifyContent="flex-end">
                                ...
                                />
                                <MDButton variant="gradient" color="info" sx={{ height: 42 }} onClick={handleSearchSubmit}>
                                    Search
                                </MDButton>
                            </MDBox>
                            ...
                            {activeType === "projects" ? (
                                <MDBox display="flex" gap={1} mb={{ xs: 1, md: 0 }}>
                                    <Select
                                        ...
                                        onChange={(e) => { setProjectTypeFilter(e.target.value); setPage(1); }}
                                        sx={filterSx}
                                    >
                    ...
                    <MDBox px={3} pb={3}>
                        ...
                        {!loading && !error && (
                            <>
                                ...
                                >
                                    <MDTypography variant="button" color="text">
                                        {total === 0 ? "No results found" : `Showing page ${currentPage} of ${totalPages} (${total} total)`}
                                    </MDTypography>
